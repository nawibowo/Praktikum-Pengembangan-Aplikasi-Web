			...
			<div id="menu">
				...
				<div id="menu_konten">
					<ul>
						...
						<li><a href="barang_belanja.php">Keranjang Belanja</a></li>
						<li><a href="barang_beli.php">Transaksi Pembelian</a></li>
						<li><a style="<?php echo $tampil_login; ?>" href="login_pengguna.php">Login</a></li>
